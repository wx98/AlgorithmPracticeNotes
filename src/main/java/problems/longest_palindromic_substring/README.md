...
详解界面->[zui-chang-hui-wen-zi-chuan-by-leetcode-solution/](https://leetcode-cn.com/problems/longest-palindromic-substring/solution/zui-chang-hui-wen-zi-chuan-by-leetcode-solution/)

>中心扩散 （面试一般会有）   
>动态规划 （面试一般会有）   
>Manacher 算法（还需要研究一下，面试能提一下最好，主要是这个状态转移有点牛逼，看不懂）    
